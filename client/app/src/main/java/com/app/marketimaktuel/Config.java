...
public class Config {
    ...
    public static final String ADMIN_PANEL_URL = "http://omerfaruknz.xyz/admin";

    //your api key which obtained from admin panel
    public static final String API_KEY = "cda11me8VupE2TF0jZNiowXQPWg6O4qLb1RCakGnYBv5KJ3txr";
