...
import com.app.marketimaktuel.utils.TouchImageView;
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            (new saveImage(ActivityWebViewImage.this)).execute(Config.ADMIN_PANEL_URL + "/upload/" + str_image);
                        }
    ...
    public class saveImage extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                MediaScannerConnection.scanFile(ActivityWebViewImage.this, as, null, new MediaScannerConnection.OnScanCompletedListener() {
