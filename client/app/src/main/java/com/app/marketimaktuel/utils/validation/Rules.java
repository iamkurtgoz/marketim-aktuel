...
package com.app.marketimaktuel.utils.validation;
    ...
    public static Rule<TextView> eq(final String failureMessage, final long expectedLong) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView textView) {
                ...
                if (actualLong != null) {
                    valid = actualLong.matches(REGEX_INTEGER) && Long.parseLong(actualLong) == expectedLong;
                }
    ...
    public static Rule<TextView> gt(final String failureMessage, final long lesserLong) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView textView) {
                ...
                String actualLong = getText(textView, true);
                if (actualLong != null) {
                    valid = actualLong.matches(REGEX_INTEGER) && Long.parseLong(actualLong) > lesserLong;
                }
    ...
    public static Rule<TextView> lt(final String failureMessage, final long greaterLong) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView textView) {
                ...
                String actualLong = getText(textView, true);
                if (actualLong != null) {
                    valid = actualLong.matches(REGEX_INTEGER) && Long.parseLong(actualLong) < greaterLong;
                }
    ...
    public static Rule<TextView> eq(final String failureMessage, final float expectedFloat) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                if (actualFloat != null) {
                    valid = actualFloat.matches(REGEX_DECIMAL) && Float.parseFloat(actualFloat) == expectedFloat;
                }
    ...
    public static Rule<TextView> gt(final String failureMessage, final float lesserFloat) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                String actualFloat = getText(view, true);
                if (actualFloat != null) {
                    valid = actualFloat.matches(REGEX_DECIMAL) && Float.parseFloat(actualFloat) > lesserFloat;
                }
    ...
    public static Rule<TextView> lt(final String failureMessage, final float greaterFloat) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                String actualFloat = getText(view, true);
                if (actualFloat != null) {
                    valid = actualFloat.matches(REGEX_DECIMAL) && Float.parseFloat(actualFloat) < greaterFloat;
                }
        ...
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                if (actualDouble != null) {
                    valid = actualDouble.matches(REGEX_DECIMAL) && Double.parseDouble(actualDouble) == expectedDouble;
                }
    ...
    public static Rule<TextView> gt(final String failureMessage, final double lesserDouble) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                String actualDouble = getText(view, true);
                if (actualDouble != null) {
                    valid = actualDouble.matches(REGEX_DECIMAL) && Double.parseDouble(actualDouble) > lesserDouble;
                }
    ...
    public static Rule<TextView> lt(final String failureMessage, final double greaterDouble) {
        return new Rule<TextView>(failureMessage) {
            ...
            public boolean isValid(TextView view) {
                ...
                String actualDouble = getText(view, true);
                if (actualDouble != null) {
                    valid = actualDouble.matches(REGEX_DECIMAL) && Double.parseDouble(actualDouble) < greaterDouble;
                }
