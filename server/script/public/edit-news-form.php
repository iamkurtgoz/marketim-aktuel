                        	...
                        	<div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div id="video_post">
                                        ...
                                        <div class="form-group">
                                           <input type="file" name="post_image" id="post_image" class="dropify-image" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png gif" data-default-file="upload/<?php echo $row['news_image']; ?>" data-show-remove="false"/>
                                    ...
                                    <div id="direct_url">
                                        <div class="form-group">
                                            <input type="file" name="image" id="image" class="dropify-image" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png gif" data-default-file="upload/<?php echo $row['news_image'];?>" data-show-remove="false"/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div id="video_upload">
                                        <div class="form-group">
                                            <input type="file" id="news_image" name="news_image" id="news_image" class="dropify-image" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png gif" data-default-file="upload/<?php echo $row['news_image'];?>" data-show-remove="false" />
                                        </div>
